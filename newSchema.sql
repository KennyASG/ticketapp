...
-- ============================
--  NUEVO: Asientos específicos por reserva
-- ============================
CREATE TABLE reservation_seats (
    id SERIAL PRIMARY KEY,
    reservation_id INTEGER NOT NULL,
    seat_id INTEGER NOT NULL,
    concert_seat_id INTEGER NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (reservation_id) REFERENCES reservations(id) ON DELETE CASCADE,
    FOREIGN KEY (seat_id) REFERENCES seats(id) ON DELETE CASCADE,
    FOREIGN KEY (concert_seat_id) REFERENCES concert_seats(id) ON DELETE CASCADE,
...
-- ============================
--  NUEVO: Asientos específicos por orden
-- ============================
...
CREATE INDEX idx_reservation_seats_concert_seat ON reservation_seats(concert_seat_id);
CREATE INDEX idx_order_seats_order ON order_seats(order_id);
CREATE INDEX idx_order_seats_concert_seat ON order_seats(concert_seat_id);
CREATE INDEX idx_concert_seats_concert_status ON concert_seats(concert_id, status_id);
...
('seat', 'reserved', TRUE),
('seat', 'occupied', TRUE),
('seat', 'in_cart', TRUE);  -- NUEVO: Para asientos en carrito (cola CARRITO)
